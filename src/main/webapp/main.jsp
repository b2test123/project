			...
			<div class="mid-mid">
				<div class="prod-board">
					...
					<div class="sub-prod-show">
						...
						<a href="#">
							<img class="sub-prod-pic" src="resources/images/main/food2.jpg" alt="">
						</a>
						<a href="#">
					...
					<div class="sub-prod-show">
						<!-- 메인 제품 외의 주요 제품 목록 -->
						<a href="">
							<img class="sub-prod-pic" src="resources/images/main/toy1.jpg" alt="">
						</a> 
						<a href="">
							<img class="sub-prod-pic" src="resources/images/main/toy2.jpg" alt="">
						</a>
						<a href="">
							<img class="sub-prod-pic" src="resources/images/main/toy3.jpg" alt="">
						</a> 
						<a href="">
							<img class="sub-prod-pic" src="resources/images/main/toy4.jpg" alt="">
						</a>
					</div>
				</div>
			</div>
