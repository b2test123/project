				...
				<table class="history_table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="td3"><fmt:formatDate value="${be.orderDate}"
									pattern="yy-MM-dd HH:mm" /></td>
							<td class="img_col"><a href="#"> <img
									src="../upload/${be.filename}" alt="">
							</a></td>
							<td class="td4">
								<!-- ${be.pname} --> <!-- </td>
                                    <td  class="td5">
							...
							<td class="td6">
								<!-- ${be.orderPrice} -->
								<p>${p.pcnt}(수량)X ${p.price}(가격)</p>
								<br>
								<p class="sub_price"></p>
							</td>
							<td class="td7">결제완료</td>
							<td class="td8"><select name="ctr" id="ctr">
